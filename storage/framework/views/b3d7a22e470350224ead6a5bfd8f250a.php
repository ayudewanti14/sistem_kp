...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-4 gap-3">
    ...
    <a href="<?php echo e(route('admin.export', array_merge(['type' => 'bpjs'], request()->all()))); ?>" class="btn btn-success rounded-pill px-4 fw-bold shadow-sm d-inline-flex align-items-center" style="height: 42px; transition: 0.3s;" onmouseover="this.style.transform='translateY(-2px)'" onmouseout="this.style.transform='translateY(0)'">
        <i class="fa-solid fa-file-excel me-2"></i> Export Excel
    </a>
</div>

<div class="filter-card mb-4 animate__animated animate__fadeIn">
    <form action="<?php echo e(route('admin.bpjs')); ?>" method="GET" class="row g-3 align-items-end">
        <div class="col-md-3">
            <label class="form-label-custom d-block">Kabupaten</label>
            <select name="kabupaten" id="filterKabupaten" class="input-modern">
                <option value="">-- Semua Kabupaten --</option>
                <?php $__currentLoopData = $listKabupaten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($kab); ?>" <?php echo e(request('kabupaten') == $kab ? 'selected' : ''); ?>><?php echo e($kab); ?></option>
        ...
        <div class="col-md-3">
            ...
            <select name="puskesmas_id" id="filterPuskesmas" class="input-modern">
                ...
                <?php $__currentLoopData = $listPuskesmas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($p->id); ?>" data-kabupaten="<?php echo e($p->kabupaten); ?>" <?php echo e(request('puskesmas_id') == $p->id ? 'selected' : ''); ?>>
                        <?php echo e($p->name); ?>
        ...
        <div class="col-md-2">
            ...
            <input type="date" name="tanggal_mulai" class="input-modern" value="<?php echo e(request('tanggal_mulai')); ?>">
        </div>
        
        <div class="col-md-2">
            <label class="form-label-custom d-block">Sampai Tanggal</label>
            <input type="date" name="tanggal_selesai" class="input-modern" value="<?php echo e(request('tanggal_selesai')); ?>">
        </div>
        ...
        <div class="col-md-2 d-flex gap-2">
            ...
            <a href="<?php echo e(route('admin.bpjs')); ?>" class="btn btn-light border shadow-sm rounded-3 d-flex align-items-center justify-content-center" style="width: 42px; height: 42px; flex-shrink: 0;" title="Reset Filter">
    ...
    <div class="table-responsive">
        <table class="table table-modern align-middle">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4">
                        <div class="fw-bold text-dark fs-6 mb-1"><?php echo e($d->nama_warga); ?></div>
                        <div class="d-flex align-items-center text-secondary" style="font-size: 0.8rem;">
                            <i class="fa-regular fa-id-card me-2 text-primary opacity-50"></i> <?php echo e($d->nik); ?>
                    ...
                    <td>
                        <div class="d-flex align-items-center">
                            <div class="bg-primary bg-opacity-10 text-primary rounded-circle d-flex align-items-center justify-content-center fw-bold me-3" style="width: 40px; height: 40px; flex-shrink:0;">
                                <?php echo e(substr($d->petugas->name ?? 'P', 0, 1)); ?>

                            </div>
                            <div>
                                <span class="fw-bold d-block text-dark" style="font-size: 0.9rem;"><?php echo e($d->petugas->name ?? 'Penginput Terhapus'); ?></span>
                                <span class="text-muted" style="font-size: 0.75rem;">
                                    <i class="fa-regular fa-clock me-1"></i> <?php echo e($d->created_at->format('d M Y, H:i')); ?>
                    ...
                    <td>
                        <div class="d-inline-flex align-items-center bg-light rounded-pill px-3 py-1 text-secondary fw-semibold mb-1" style="font-size: 0.8rem;">
                            <i class="fa-solid fa-map-location-dot me-2 text-danger opacity-75"></i> <?php echo e($d->petugas->kabupaten ?? '-'); ?>

                        </div>
                        <div class="text-muted ms-2" style="font-size: 0.8rem;">Kec. <?php echo e($d->petugas->kecamatan ?? '-'); ?></div>
                    </td>
                    
                    <td>
                        <div class="d-flex flex-wrap gap-2">
                            <button type="button" class="doc-badge doc-ktp btn-preview" data-url="<?php echo e($d->foto_ktp); ?>" data-title="KTP - <?php echo e($d->nama_warga); ?>">
                                <i class="fa-solid fa-address-card"></i> KTP
                            </button>
                            
                            <button type="button" class="doc-badge doc-kk btn-preview" data-url="<?php echo e($d->foto_kk); ?>" data-title="KK - <?php echo e($d->nama_warga); ?>">
                                <i class="fa-solid fa-users-rectangle"></i> KK
                            </button>
                            
                            <?php if(!empty($d->foto_sktm)): ?>
                            <button type="button" class="doc-badge doc-sktm btn-preview" data-url="<?php echo e($d->foto_sktm); ?>" data-title="SKTM - <?php echo e($d->nama_warga); ?>">
                                <i class="fa-solid fa-file-signature"></i> SKTM
                            </button>
                            <?php endif; ?>

                            <?php if(!empty($d->foto_rawat)): ?>
                            <button type="button" class="doc-badge doc-rawat btn-preview" data-url="<?php echo e($d->foto_rawat); ?>" data-title="Foto Rawat - <?php echo e($d->nama_warga); ?>">
                    ...
                    <td>
                        <?php if($d->status_verifikasi == 'acc'): ?>
                        ...
                        <?php elseif($d->status_verifikasi == 'ditolak'): ?>
                            <div>
                                ...
                                <div class="p-2 bg-danger bg-opacity-10 text-danger rounded-3 border border-danger border-opacity-25 mt-1" style="font-size: 0.7rem; line-height: 1.4;">
                                    <strong>Ket:</strong> <?php echo e($d->alasan_ditolak ?? 'Tidak ada alasan.'); ?>
                    ...
                    <td class="text-center">
                        <div class="d-flex justify-content-center gap-2 bg-light p-1 rounded-pill border mx-auto" style="width: fit-content;">
                            <form action="<?php echo e(route('admin.bpjs.approve', $d->id)); ?>" method="POST" class="form-konfirmasi" data-aksi="Menyetujui" data-nama="<?php echo e($d->nama_warga); ?>" data-icon="success">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <button type="submit" class="btn btn-sm <?php echo e($d->status_verifikasi == 'acc' ? 'btn-light text-muted disabled border-0' : 'btn-success shadow-sm'); ?> rounded-circle d-flex align-items-center justify-content-center hover-scale" style="width: 36px; height: 36px;" title="Setujui Pengajuan">
                                    <i class="fa-solid fa-check"></i>
                                </button>
                            </form>
                            <div class="vr opacity-25 my-1"></div>
                            <form action="<?php echo e(route('admin.bpjs.reject', $d->id)); ?>" method="POST" class="form-konfirmasi" data-aksi="Menolak" data-nama="<?php echo e($d->nama_warga); ?>" data-icon="error">
                                <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>
                                <button type="submit" class="btn btn-sm <?php echo e($d->status_verifikasi == 'ditolak' ? 'btn-light text-muted disabled border-0' : 'btn-danger shadow-sm'); ?> rounded-circle d-flex align-items-center justify-content-center hover-scale" style="width: 36px; height: 36px;" title="Tolak Pengajuan">
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/bpjs.blade.php ENDPATH**/ ?>