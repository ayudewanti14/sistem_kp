        ...
        <ul class="nav nav-pills-custom" id="userTabs" role="tablist">
            <li class="nav-item">
                <button class="nav-link active" id="admin-tab" data-bs-toggle="tab" data-bs-target="#admin-panel" type="button">
                    <i class="fa-solid fa-user-shield"></i> Admin Sistem <span class="badge-tab"><?php echo e($admins->count()); ?></span>
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" id="puskesmas-tab" data-bs-toggle="tab" data-bs-target="#puskesmas-panel" type="button">
                    <i class="fa-solid fa-file-medical"></i> Penginput BPJS <span class="badge-tab"><?php echo e($puskesmas->count()); ?></span>
                </button>
            </li>
            <li class="nav-item">
                <button class="nav-link" id="driver-tab" data-bs-toggle="tab" data-bs-target="#driver-panel" type="button">
                    <i class="fa-solid fa-truck-medical"></i> Ambulan <span class="badge-tab"><?php echo e($drivers->count()); ?></span>
                </button>
            </li>
        </ul>
    </div>
    ...
    <div class="tab-content" id="userTabsContent">
                        ...
                        <tr>
                            <td class="col-nama ps-md-4" data-label="Nama Admin">
                                <div class="d-flex align-items-center w-100">
                                    ...
                                    <span class="fw-bold text-dark text-start" style="font-size: 0.95rem;"><?php echo e($u->name); ?></span>
                                </div>
                            </td>
                            <td data-label="Email"><span class="text-muted"><?php echo e($u->email); ?></span></td>
                            ...
                            <td class="col-aksi text-center">
                                <?php if(Auth::id() != $u->id): ?> 
                                    <div class="d-flex justify-content-center gap-2">
                                        <a href="<?php echo e(route('admin.users.edit', $u->id)); ?>" class="btn-action edit"><i class="fa-solid fa-pen"></i></a>
                                        <form action="<?php echo e(route('admin.users.delete', $u->id)); ?>" method="POST" class="d-inline form-delete">
        ...
        <div class="tab-pane fade" id="puskesmas-panel">
            <div class="accordion accordion-custom" id="accordionPuskesmas">
                <?php $groupedPuskesmas = $puskesmas->groupBy('kabupaten'); ?>
                <?php $__empty_1 = true; $__currentLoopData = $groupedPuskesmas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kabupaten => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $targetIdP = str_replace([' ', '.'], '_', $kabupaten ?? 'Lain_lain'); ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseP_<?php echo e($targetIdP); ?>">
                                <div class="d-flex align-items-center justify-content-between w-100 me-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fw-bold text-dark mb-0 lh-1"><?php echo e(strtoupper($kabupaten ?? 'Wilayah Belum Terdata')); ?></h6>
                                            <small class="text-muted mt-1 d-block fw-semibold"><?php echo e($items->count()); ?> Penginput Terdaftar</small>
                                        </div>
                                    </div>
                                </div>
                            </button>
                        </h2>
                        <div id="collapseP_<?php echo e($targetIdP); ?>" class="accordion-collapse collapse" data-bs-parent="#accordionPuskesmas">
                            <div class="accordion-body p-0 border-top">
                                <table class="table table-modern table-responsive-mobile">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $u): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td data-label="Kecamatan">
                                                <div class="d-inline-flex align-items-center bg-light rounded-pill px-3 py-1 text-secondary fw-semibold" style="font-size: 0.85rem;">
                                                    <i class="fa-solid fa-location-dot me-2 text-muted"></i> <?php echo e($u->kecamatan ?? '-'); ?>
        ...
        <div class="tab-pane fade" id="driver-panel">
            <div class="accordion accordion-custom" id="accordionDriver">
                <?php $groupedDrivers = $drivers->groupBy('kabupaten'); ?>
                <?php $__empty_1 = true; $__currentLoopData = $groupedDrivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kabupaten => $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php $targetIdD = str_replace([' ', '.'], '_', $kabupaten ?? 'Lain_lain'); ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseD_<?php echo e($targetIdD); ?>">
                                <div class="d-flex align-items-center justify-content-between w-100 me-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            <h6 class="fw-bold text-dark mb-0 lh-1"><?php echo e(strtoupper($kabupaten ?? 'Wilayah Belum Terdata')); ?></h6>
                                            <small class="text-muted mt-1 d-block fw-semibold"><?php echo e($items->count()); ?> Pengemudi Siaga</small>
                                        </div>
                                    </div>
                                </div>
                            </button>
                        </h2>
                        <div id="collapseD_<?php echo e($targetIdD); ?>" class="accordion-collapse collapse" data-bs-parent="#accordionDriver">
                            <div class="accordion-body p-0 border-top">
                                <table class="table table-modern table-responsive-mobile">
                                    <thead>
                                        <tr>
                                        ...
                                        <tr>
                                            <td class="col-nama ps-md-4" data-label="Pengemudi">
                                                <div class="d-flex align-items-center w-100">
                                                    ...
                                                    <div>
                                                        <span class="fw-bold text-dark text-start d-block" style="font-size: 0.95rem;"><?php echo e($u->name); ?></span>
                                                        <?php if($u->nopol): ?>
                                                        <span class="badge bg-secondary bg-opacity-10 text-secondary border border-secondary border-opacity-25 mt-1">
                                                            <i class="fa-solid fa-car-side me-1"></i> <?php echo e($u->nopol); ?>
                                            ...
                                            <td data-label="Wilayah Tugas">
                                                <div class="fw-bold text-dark" style="font-size: 0.9rem;"><?php echo e($u->kecamatan ?? '-'); ?></div>
                                                <div class="text-muted" style="font-size: 0.8rem;"><i class="fa-solid fa-map-pin me-1 opacity-50"></i> <?php echo e($u->unit_kerja ?? 'Desa belum diatur'); ?></div>
                                            </td>
                                            <td data-label="WhatsApp">
                                                <?php if($u->no_hp): ?>
                                                <a href="https://wa.me/<?php echo e($waFormat); ?>" target="_blank" class="btn btn-sm btn-light text-success fw-bold rounded-pill px-3 shadow-sm border border-success-subtle hover-scale" style="transition: 0.2s;">
                                            ...
                                            <td data-label="Kepala Desa">
                                                <div class="d-inline-flex align-items-center bg-light rounded-3 px-3 py-2 text-secondary" style="font-size: 0.85rem;">
                                                    <i class="fa-solid fa-user-tie me-2 text-muted"></i> <?php echo e($u->nama_kepala_desa ?? 'Belum Diisi'); ?>
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/users.blade.php ENDPATH**/ ?>