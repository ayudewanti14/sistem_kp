...
<div class="row g-3 mb-4">
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 bg-primary text-white overflow-hidden">
            <div class="card-body p-4 position-relative">
                <h3 class="fw-bold mb-0"><?php echo e($totalAmbulan); ?></h3>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 bg-warning text-dark overflow-hidden">
            <div class="card-body p-4 position-relative">
                <h3 class="fw-bold mb-0"><?php echo e($sedangJalan); ?></h3>
    ...
    <div class="col-md-4">
        <div class="card border-0 shadow-sm rounded-4 bg-success text-white overflow-hidden">
            <div class="card-body p-4 position-relative">
                <h3 class="fw-bold mb-0"><?php echo e($tersedia); ?></h3>
...
<?php if(!$isFiltering): ?>
    ...
    <div class="row g-3">
        <?php $__empty_1 = true; $__currentLoopData = $listKabupaten; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kab): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card border-0 shadow-sm h-100 hover-card position-relative">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="fw-bold text-dark mb-1"><?php echo e($kab->display_name); ?></h6>
                        <small class="text-muted"><i class="fa-solid fa-truck-medical me-1"></i> <?php echo e($kab->jumlah_unit); ?> Unit Armada</small>
                    </div>
                    <div class="bg-light rounded-circle p-3 text-primary">
                        <i class="fa-solid fa-chevron-right"></i>
                    </div>
                </div>
                <a href="<?php echo e(route('admin.ambulan', ['kabupaten' => $kab->kabupaten ?? 'Lain-lain'])); ?>" class="stretched-link"></a>
            </div>
        </div>
...
<?php else: ?>
    <div class="d-flex align-items-center justify-content-between mb-3">
        <div>
            <a href="<?php echo e(route('admin.ambulan')); ?>" class="btn btn-light border me-2 shadow-sm rounded-pill px-3">
                <i class="fa-solid fa-arrow-left me-1"></i> Kembali
            </a>
            <span class="fw-bold fs-5 text-dark align-middle">
                <i class="fa-solid fa-building-flag me-2 text-primary"></i> <?php echo e($selectedKabupaten); ?>
        ...
        <div class="card-body p-0 bg-light" style="max-height: 600px; overflow-y: auto;">
            <div class="p-4">
                <div class="row g-4" id="unitContainer">
                    <?php $__empty_1 = true; $__currentLoopData = $armadaPerWilayah; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kecamatan => $drivers): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="col-12 unit-group" data-search="<?php echo e(strtolower($kecamatan)); ?> <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> <?php echo e(strtolower($d->name)); ?> <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>">
                        <h6 class="fw-bold text-secondary text-uppercase border-bottom pb-2 mb-3 mt-2 sticky-top bg-light pt-2" style="top: 0; z-index: 5;">
                            <i class="fa-solid fa-map-pin me-2 text-danger"></i> <?php echo e($kecamatan); ?>

                        </h6>

                        <div class="row g-3">
                            <?php $__currentLoopData = $drivers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $drv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col-md-6 col-lg-4 col-xl-3 unit-item">
                                <a href="<?php echo e(route('admin.ambulan.detail', $drv->id)); ?>" class="text-decoration-none">
                                    <div class="card border-0 shadow-sm h-100 position-relative overflow-hidden hover-card-detail">
                                        <div class="position-absolute start-0 top-0 bottom-0 <?php echo e($drv->status_sekarang == 'sibuk' ? 'bg-warning' : 'bg-success'); ?>" style="width: 4px;"></div>
                                        <div class="card-body p-3 ps-4 text-dark">
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div style="width: 70%;">
                                                    <h6 class="fw-bold mb-0 text-truncate"><?php echo e($drv->name); ?></h6>
                                                    <small class="text-muted d-block text-truncate"><?php echo e($drv->unit_kerja ?? 'Desa ?'); ?></small>
                                                </div>
                                            </div>
                                            <div class="bg-light rounded p-2 border mb-2">
                                                <small class="text-muted d-block" style="font-size: 0.65rem;">KONTAK WA:</small>
                                                <span class="fw-bold text-success small">
                                                    <i class="fa-brands fa-whatsapp me-1"></i> <?php echo e($drv->no_hp ?? '-'); ?>

                                                </span>
                                            </div>
                                            <?php if($drv->status_sekarang == 'sibuk'): ?>
...
<div class="mt-5 border-top pt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="<?php echo e(route('admin.export', 'ambulan')); ?>" class="btn btn-success btn-sm shadow-sm rounded-3">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0" style="font-family: 'Poppins', sans-serif;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td class="ps-4">
                            <div class="fw-bold text-dark" style="font-size: 0.85rem;"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('d/m/Y')); ?></div>
                            <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('H:i')); ?> WIB</small>
                        </td>
                        <td>
                            <div class="fw-bold text-dark" style="font-size: 0.85rem;"><?php echo e($log->driver->name ?? 'User Dihapus'); ?></div>
                            <small class="text-muted">Kades: <?php echo e($log->driver->nama_kepala_desa ?? '-'); ?></small>
                        </td>
                        
                        <td>
                            <div class="fw-bold text-dark" style="font-size: 0.85rem;"><?php echo e($log->nama_pasien ?? 'Sedang Berjalan'); ?></div>
                            <?php if($log->jenis_pelayanan): ?>
                                <span class="badge bg-info bg-opacity-10 text-info border border-info-subtle mt-1" style="font-size: 0.65rem;">
                                    <?php echo e($log->jenis_pelayanan); ?>
                        ...
                        <td>
                            <div style="font-size: 0.8rem;"><b>Dari:</b> <span class="text-muted"><?php echo e($log->lokasi_jemput ?? '-'); ?></span></div>
                            <div style="font-size: 0.8rem;" class="text-primary"><b>Ke:</b> <?php echo e($log->tujuan ?? '-'); ?></div>
                        </td>
                        <td class="text-center">
                            <?php if($log->foto_ktp): ?>
                                <button type="button" class="btn btn-sm btn-light text-primary btn-preview-bukti rounded-pill px-3 hover-scale fw-medium" 
                                        data-url="<?php echo e($log->foto_ktp); ?>" 
                                        data-title="Bukti Pasien: <?php echo e($log->nama_pasien); ?>">
                        ...
                        <td class="text-center">
                            <form action="<?php echo e(route('admin.ambulan.destroy', $log->id)); ?>" method="POST" class="form-hapus-log d-inline-block" data-nama="<?php echo e($log->driver->name ?? 'Driver'); ?>">
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/ambulan.blade.php ENDPATH**/ ?>