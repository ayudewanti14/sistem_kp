...
<div class="container-fluid p-0">
            ...
            <div class="row align-items-center">
                <div class="col-lg-8 text-white">
                    <div class="mb-2">
                        ...
                        <h2 class="fw-light opacity-90 fs-3 mb-3"><?php echo e(Auth::user()->name); ?></h2>
                    </div>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e(\App\Models\User::count()); ?></h2>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e(\App\Models\BpjsData::count()); ?></h2>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e(\App\Models\AmbulanceLog::where('status', 'jalan')->count()); ?></h2>
            ...
            <div class="card border-0 shadow-sm rounded-4 h-100 hover-card">
                <div class="card-body p-4 d-flex align-items-center justify-content-between">
                    <div>
                        ...
                        ?>
                        <h2 class="fw-bold mb-0 text-dark"><?php echo e($total - $jalan); ?></h2>
    ...
    <div class="row g-4">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('admin.bpjs')); ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 hover-card rounded-5 overflow-hidden">
                    <div class="card-body p-5 text-center">
        ...
        <div class="col-md-4">
            <a href="<?php echo e(route('admin.ambulan')); ?>" class="text-decoration-none">
                <div class="card border-0 shadow-sm h-100 hover-card rounded-5 overflow-hidden">
                    <div class="card-body p-5 text-center">
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/hub.blade.php ENDPATH**/ ?>