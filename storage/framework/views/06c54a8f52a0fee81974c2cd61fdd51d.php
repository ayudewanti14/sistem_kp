        ...
        <div class="brand-content">
            ...
            <div class="leader-photo-container">
                <div class="leader-photo-frame">
                    <img src="<?php echo e(asset('images/gubernur-wakil-gubernur-bengkulu.png')); ?>" alt="Gubernur dan Wakil Gubernur Bengkulu">
                </div>
    ...
    <div class="form-side">
        ...
        <form method="POST" action="<?php echo e(route('login.post')); ?>">
            ...
            <div class="input-group-custom">
                <input type="email" name="email" class="form-control-custom" placeholder="Alamat Email Dinas" value="<?php echo e(old('email')); ?>" required autofocus>
        ...
        <div class="form-footer">
            &copy; <?php echo e(date('Y')); ?> Dinkes Provinsi Bengkulu.<br>Akses Terbatas Petugas Otorisasi.
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\kpdinkes\resources\views/auth/login.blade.php ENDPATH**/ ?>