...
<div class="container" style="max-width: 800px;">
    ...
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="<?php echo e(route('admin.users')); ?>" class="btn btn-light border shadow-sm rounded-pill px-4">
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <select name="role" id="roleSelect" class="form-select form-select-lg bg-light" required onchange="updateEditForm()">
                            ...
                            <option value="puskesmas" <?php echo e($user->role == 'puskesmas' ? 'selected' : ''); ?>>Petugas Puskesmas</option>
                            <option value="ambulan" <?php echo e($user->role == 'ambulan' ? 'selected' : ''); ?>>Driver Ambulan</option>
                        </select>
                    </div>
                    ...
                    <div class="col-md-12" id="unitBox">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="unit_kerja" class="form-control border-start-0" value="<?php echo e($user->unit_kerja); ?>" placeholder="...">
                        </div>
                        ...
                        <div id="kadesBox" style="display: none;">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" name="nama_kepala_desa" class="form-control border-start-0" value="<?php echo e($user->nama_kepala_desa); ?>" placeholder="Masukkan Nama Kades...">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="number" name="no_hp" class="form-control" value="<?php echo e($user->no_hp); ?>" placeholder="08...">
                    </div>
                    ...
                    <div class="col-md-12" id="nopolBox" style="display: none;">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" name="nopol" class="form-control border-start-0 text-uppercase" value="<?php echo e($user->nopol); ?>" placeholder="Contoh: BD 1234 XY">
                        </div>
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        let wilayahSelect = document.getElementById('wilayahSelect');
        let userWilayah = "<?php echo e($user->kabupaten); ?>";
        let userKec = "<?php echo e($user->kecamatan); ?>";
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/users_edit.blade.php ENDPATH**/ ?>