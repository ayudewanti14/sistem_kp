    ...
    <div class="driver-id-card">
        <div class="d-flex align-items-center flex-column flex-md-row gap-3 gap-md-4">
            ...
            <div class="driver-info text-center text-md-start">
                ...
                <h2 class="fw-900"><?php echo e(Auth::user()->name); ?></h2>
                <div class="badge-unit"><i class="fa-solid fa-truck-medical me-1"></i> <?php echo e(Auth::user()->unit_kerja ?? 'Unit Darurat'); ?></div>
            </div>
        </div>
        <div class="text-center text-md-end mt-3 mt-md-0">
            <div id="liveDigitalClock" class="fw-900 text-dark fs-4">--:--:-- WIB</div>
            <a href="<?php echo e(route('ambulan.profil')); ?>" class="btn btn-sm btn-outline-primary rounded-pill fw-bold mt-2">
                ...
                <div class="active-zone">
                    <div class="warning-header">
                        ...
                        <div class="fw-bold mt-2 text-white opacity-75 bg-black bg-opacity-25 d-inline-block px-4 py-2 rounded-pill">
                            Berangkat: <?php echo e(\Carbon\Carbon::parse($activeTrip->waktu_berangkat)->timezone('Asia/Jakarta')->format('H:i')); ?> WIB
                        </div>
                    </div>

                    <div class="p-4 p-md-5 bg-white">
                        <form id="finishForm" action="<?php echo e(route('ambulan.finish', $activeTrip->id)); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
    ...
    <?php else: ?>
        <div class="standby-zone mb-5">
            ...
            <div class="radar-container">
                ...
                <form action="<?php echo e(route('ambulan.start')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
            ...
            <table class="table table-custom table-hover">
                ...
                <tbody>
                    <?php $__empty_1 = true; $__currentLoopData = $riwayat; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <td>
                                <div class="fw-800 text-dark"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('d M Y')); ?></div>
                                <div class="text-muted small"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('H:i')); ?> WIB</div>
                            </td>
                            <td><div class="fw-900 text-dark"><?php echo e($log->nama_pasien); ?></div></td>
                            <td>
                                <div class="small fw-bold text-primary"><?php echo e($log->jenis_pelayanan); ?></div>
                                <div class="text-muted small"><?php echo e($log->lokasi_jemput); ?> ➔ <?php echo e($log->tujuan); ?></div>
                            </td>
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/dashboard_ambulan.blade.php ENDPATH**/ ?>