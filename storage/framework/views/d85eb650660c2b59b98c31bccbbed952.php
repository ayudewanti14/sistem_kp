    ...
    <div class="header-gradient mb-4">
        <div class="d-flex justify-content-between align-items-end position-relative" style="z-index: 2;">
            <div>
                ...
                <p class="mb-0 opacity-75">Halo, <?php echo e(Auth::user()->name); ?>. Mari bantu warga mendapatkan hak kesehatannya.</p>
            </div>
            <div class="d-flex gap-3 d-none d-md-flex">
                <div class="glass-stat text-center px-4">
                    <h2 class="fw-bold mb-0"><?php echo e($myData->count()); ?></h2>
                    <small class="text-white-50">Total Input</small>
                </div>
                <div class="glass-stat text-center px-4">
                    <h2 class="fw-bold mb-0 text-warning"><?php echo e($myData->where('status_verifikasi', 'pending')->count()); ?></h2>
        ...
        <div class="card-body p-4">
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade show active" id="form">
                    <form action="<?php echo e(route('puskesmas.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                ...
                <div class="tab-pane fade" id="history">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover align-middle">
                            ...
                            <tbody id="tableBody">
                                <?php $__empty_1 = true; $__currentLoopData = $myData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="data-row">
                                    <td class="ps-3 text-muted" style="width: 180px;">
                                        <i class="fa-regular fa-calendar me-2"></i> <?php echo e($data->created_at->format('d/m/Y')); ?>

                                        <br>
                                        <small class="ms-4"><?php echo e($data->created_at->format('H:i')); ?> WIB</small>
                                    </td>
                                    <td>
                                        <span class="d-block fw-bold text-dark fs-6"><?php echo e($data->nama_warga); ?></span>
                                        <small class="d-block text-muted mt-1"><i class="fa-brands fa-whatsapp me-1 text-success"></i> <?php echo e($data->no_hp); ?></small>
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($data->status_verifikasi == 'acc'): ?>
                                        ...
                                        <?php else: ?>
                                            <div>
                                                ...
                                                <div class="small p-2 bg-danger bg-opacity-10 text-danger rounded-3 border border-danger border-opacity-25 mt-1" style="max-width: 300px; font-size: 0.75rem;">
                                                    <strong>Alasan:</strong> <?php echo e($data->alasan_ditolak ?? 'Tidak ada alasan.'); ?>
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/dashboard_puskesmas.blade.php ENDPATH**/ ?>