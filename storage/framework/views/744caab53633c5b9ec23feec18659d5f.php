...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('images/logoprov.png')); ?>" type="image/png">
...
<div class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-menu">
        <?php if(Auth::user()->role == 'admin'): ?>
            ...
            <li><a href="<?php echo e(route('admin.home')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.home') ? 'active' : ''); ?>"><i class="fa-solid fa-chart-pie me-2"></i> Dashboard</a></li>
            <li><a href="<?php echo e(route('admin.users')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.users*') ? 'active' : ''); ?>"><i class="fa-solid fa-user-gear me-2"></i> Manajemen User</a></li>
            <li class="menu-header">Monitoring</li>
            <li><a href="<?php echo e(route('admin.bpjs')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.bpjs') ? 'active' : ''); ?>"><i class="fa-solid fa-shield-heart me-2"></i> Data BPJS</a></li>
            <li><a href="<?php echo e(route('admin.ambulan')); ?>" class="nav-link <?php echo e(request()->routeIs('admin.ambulan') ? 'active' : ''); ?>"><i class="fa-solid fa-truck-fast me-2"></i> Log Ambulan</a></li>
        <?php endif; ?>

        <?php if(Auth::user()->role == 'puskesmas'): ?>
            <li class="menu-header">Layanan</li>
            <li><a href="<?php echo e(route('puskesmas.home')); ?>" class="nav-link <?php echo e(request()->routeIs('puskesmas.home') ? 'active' : ''); ?>"><i class="fa-solid fa-file-waveform me-2"></i> Portal Penginput</a></li>
        <?php endif; ?>

        <?php if(Auth::user()->role == 'ambulan'): ?>
            <li class="menu-header">Operasional</li>
            <li><a href="<?php echo e(route('ambulan.dashboard')); ?>" class="nav-link <?php echo e(request()->routeIs('ambulan.dashboard') ? 'active' : ''); ?>"><i class="fa-solid fa-gauge-high me-2"></i> Dashboard Driver</a></li>
            <li><a href="<?php echo e(route('ambulan.profil')); ?>" class="nav-link <?php echo e(request()->routeIs('ambulan.profil') ? 'active' : ''); ?>"><i class="fa-solid fa-user-circle me-2"></i> Profil Saya</a></li>
        <?php endif; ?>
    </ul>
    ...
    <div class="user-profile">
        <div class="d-flex align-items-center">
            ...
            <div class="ms-3 overflow-hidden">
                <div class="fw-bold text-white text-truncate small"><?php echo e(Auth::user()->name); ?></div>
                <div class="text-info fw-bold" style="font-size: 0.6rem; text-transform: uppercase;"><?php echo e(Auth::user()->role == 'puskesmas' ? 'Penginput' : Auth::user()->role); ?></div>
            </div>
        </div>
...
<div id="laravel-notifications" 
     ...
     data-error="<?php echo e($errors->any() ? implode('<br>', $errors->all()) : ''); ?>" 
     style="display: none;">
</div>
...
</html><?php /**PATH C:\laragon\www\kpdinkes\resources\views/layouts/admin_bootstrap.blade.php ENDPATH**/ ?>