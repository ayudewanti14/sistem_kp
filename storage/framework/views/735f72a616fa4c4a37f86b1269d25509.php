...
<div class="mb-4">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <a href="<?php echo e(route('admin.ambulan')); ?>" class="btn btn-light border rounded-pill px-3 shadow-sm">
            <i class="fa-solid fa-arrow-left me-1"></i> Kembali ke Wilayah
        </a>
        <a href="<?php echo e(route('admin.export', ['type' => 'ambulan_personal', 'driver_id' => $driver->id])); ?>" class="btn btn-success rounded-3 shadow-sm">
    ...
    <div class="card border-0 shadow-sm rounded-4 p-4 bg-primary text-white overflow-hidden position-relative">
        <div class="d-flex align-items-center position-relative" style="z-index: 2;">
            ...
            <div>
                <h4 class="fw-bold mb-0"><?php echo e($driver->name); ?></h4>
                <p class="mb-0 opacity-75"><?php echo e($driver->kabupaten); ?> | <?php echo e($driver->unit_kerja); ?></p>
            </div>
            <div class="ms-auto text-end">
                <h2 class="fw-bold mb-0"><?php echo e($driver->total_trip); ?></h2>
    ...
    <div class="table-responsive">
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    <td class="ps-4">
                        <div class="fw-bold text-dark small"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('d M Y')); ?></div>
                        <small class="text-muted"><?php echo e(\Carbon\Carbon::parse($log->waktu_berangkat)->format('H:i')); ?> WIB</small>
                    </td>
                    <td class="fw-bold text-primary"><?php echo e($log->tujuan ?? 'Tujuan Belum Diisi'); ?></td>
                    <td class="small text-muted"><?php echo e($log->lokasi_jemput ?? '-'); ?></td>
...
<?php echo $__env->make('layouts.admin_bootstrap', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\kpdinkes\resources\views/admin/ambulan_detail.blade.php ENDPATH**/ ?>